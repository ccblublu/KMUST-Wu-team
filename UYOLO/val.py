...
from utils.general import (LOGGER, box_iou,MPDIoU, check_dataset, check_img_size,
...
def run(
    ...
    with open('/home/zzd/ZZD/ZZDpy/yolov5L+mixiou+seg+C3CA/data/VOC.yaml', 'r') as f:
        voc_data = yaml.safe_load(f)
    # names = {
    #     k: v
    #     for k, v in enumerate(
    #         model.names if hasattr(model, 'names') else model.module.names)
    #}
    names = {k: v for k, v in enumerate(voc_data['names'])}
...
def parse_opt():
    ...
    parser.add_argument('--weights',
                        nargs='+',
                        type=str,
                        #default=ROOT / '/home/zzd/ZZD/ZZDpy/yolov5L+mixiou+seg+C3CA/runs/train/F1H-cq-iou0.883-0.818-hyp3/weights/best.pt',  #更新训练出的权重文件
                        #default=ROOT / '/home/zzd/ZZD/ZZDpy/yolov5L+mixiou+seg+C3CA/runs/train/F1H-cs-iou-0.872-0.805-hyp3/weights/best.pt',
                        default=ROOT / '/home/zzd/ZZD/ZZDpy/yolov5L+mixiou+seg+C3CA/runs/train/F1H-nocat-iou0.841-0.804-hyp3/weights/best.pt',
