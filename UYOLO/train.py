...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights',
                        type=str,
                        default=ROOT / 'weights/yolov5m.pt',
                        help='initial weights path')
    parser.add_argument('--cfg', type=str, default='/home/zzd/ZZD/ZZDpy/yolov5L+mixiou+seg+C3CA/models/u-shape-F1H-cq.yaml', help='model.yaml path')
    parser.add_argument('--data',
                        type=str,
                        default=ROOT / '/home/zzd/ZZD/ZZDpy/yolov5L+mixiou+seg+C3CA/data/VOC.yaml',
