...
def train(
    ...
    # Model attributes
    nl = de_parallel(
        model).model[24].nl  # number of detection layers (to scale hyps)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='/home/zzd/ZZD/ZZDpy/SW-light/models/yolov5m-segorigin.yaml', help='model.yaml path')
