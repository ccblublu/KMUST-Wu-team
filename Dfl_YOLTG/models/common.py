...
from utils.general import LOGGER,check_suffix,check_requirements, non_max_suppression, make_divisible, scale_coords, increment_path, xywh2xyxy, xyxy2xywh
...
class SEBlock(nn.Module):
    def __init__(self, mode, channels, ratio):
        ...
        self.fc_layers = nn.Sequential(nn.Linear(in_features = channels,out_features = channels // ratio, bias = False),
                nn.ReLU(),nn.Linear(in_features = channels // ratio, out_features = channels, bias = False),
        )
