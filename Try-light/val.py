...
def run(
    ...
    with open('/home/zzd/ZZD/ZZDpy/SW-light/data/VOC.yaml', 'r') as f:
    ...
    for batch_i, (im, masks, targets, paths, shapes) in enumerate(pbar):
        ...
        # if gradcam:
        # cam = GradCAM(model=model.model, target_layers=model.model.model[detect_layers], use_cuda=True)
...
def parse_opt():
    ...
    parser.add_argument('--weights',
                        nargs='+',
                        type=str,
                        default=ROOT / '/home/zzd/ZZD/ZZDpy/SW-light/runs/train/exp32/weights/best.pt',  #更新训练出的权重文件
